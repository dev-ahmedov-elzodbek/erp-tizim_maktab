...
export interface Teacher {
  ...
  workHistory?: TeacherExperience[];
  schedule?: { days: string; time: string }[];
}

export const teachers: Teacher[] = [
  {
    id: "t1", name: "Akmal Karimov", role: "JavaScript Lead", category: "Frontend",
    ...
    courses: 12, students: 540, rating: 4.9, experience: 8,
    ...
    workHistory: [
      { period: "2022 — hozir", title: "JavaScript Lead", company: "O'quv Markaz, Toshkent", location: "Toshkent", description: "JavaScript yo'nalishi rahbari. 12 ta kurs muallifi, o'quv dasturlarini ishlab chiqish va yangi o'qituvchilarni tayyorlash.", current: true },
      { period: "2020 — 2022", title: "Senior Frontend Developer", company: "Uzcard, Toshkent", location: "Toshkent", description: "To'lov tizimlari uchun web ilovalar. React + TypeScript stack, 1 mln+ foydalanuvchili mahsulotlar." },
      { period: "2018 — 2020", title: "Frontend Developer", company: "EPAM Systems", location: "Toshkent", description: "Xalqaro fintech loyihalarida frontend ishlab chiqish, kod sifati bo'yicha mentorlik." },
    ],
    schedule: [

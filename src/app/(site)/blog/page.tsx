...
export const metadata: Metadata = {
  title: "Blog — O'quv Markaz",
  description:
    "IT, dasturlash, dizayn va karyera bo'yicha foydali maqolalar va yangiliklar.",
};
        ...
        <div className="mt-12 grid gap-8 lg:grid-cols-[1fr_320px]">
          ...
          <div>
            ...
            <Pagination className="mt-10">
              <PaginationContent>
                <PaginationItem>
                  <PaginationPrevious href="#" text="Oldingi" />
                </PaginationItem>
                <PaginationItem>
                ...
                <PaginationItem>
                  <PaginationNext href="#" text="Keyingi" />
                </PaginationItem>
              </PaginationContent>
            </Pagination>
          </div>

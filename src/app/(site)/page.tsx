...
export const metadata: Metadata = {
  title: "O'quv Markaz — IT va dizayn ta'lim markazi",
  description:
    "Zamonaviy IT kasblarini tajribali mentorlar bilan o'rganing. 35+ kurs, amaliy loyihalar va ishga joylashishda ko'mak.",
};
            ...
            <div>
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                ...
                <Button
                  ...
                  asChild
                >
                  <Link href="/aloqa">Bepul konsultatsiya</Link>
                </Button>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                ...
                <Button
                  ...
                  asChild
                >
                  <Link href="/aloqa">Savol berish</Link>
                </Button>
              </div>
            </div>

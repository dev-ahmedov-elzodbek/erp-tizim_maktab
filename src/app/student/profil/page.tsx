      ...
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        <Card className="rounded-xl border-slate-200 shadow-xs">
          <CardContent className="p-5">
            <div className="flex size-10 items-center justify-center rounded-lg bg-blue-50 text-blue-600"><CircleDot className="size-5" /></div>
            <p className="mt-3 text-3xl font-bold text-slate-900">{statsData.avgScore}%</p>
            <p className="mt-0.5 text-sm text-slate-500">O&apos;rtacha natija</p>
          </CardContent>
        </Card>
        <Card className="rounded-xl border-slate-200 shadow-xs">
          <CardContent className="p-5">
            <div className="flex size-10 items-center justify-center rounded-lg bg-emerald-50 text-emerald-600"><Clock className="size-5" /></div>
            <p className="mt-3 text-3xl font-bold text-slate-900">{statsData.studyHours}</p>
            <p className="mt-0.5 text-sm text-slate-500">O&apos;rganilgan soat</p>
          </CardContent>
        </Card>
        <Card className="rounded-xl border-slate-200 shadow-xs">
          <CardContent className="p-5">
            <div className="flex size-10 items-center justify-center rounded-lg bg-amber-50 text-amber-600"><BookOpen className="size-5" /></div>
            <p className="mt-3 text-3xl font-bold text-slate-900">{statsData.totalCourses}</p>
            <p className="mt-0.5 text-sm text-slate-500">Jami kurslar</p>
          </CardContent>
        </Card>
        <Card className="rounded-xl border-slate-200 shadow-xs">
          <CardContent className="p-5">
            <div className="flex size-10 items-center justify-center rounded-lg bg-orange-50 text-orange-600"><Award className="size-5" /></div>
            <p className="mt-3 text-3xl font-bold text-slate-900">{statsData.certificates}</p>
            <p className="mt-0.5 text-sm text-slate-500">Sertifikat</p>
          </CardContent>
        </Card>
      </div>
          ...
          <CardContent className="p-6">
            ...
            <div className="mt-4 flex items-start gap-2.5 rounded-lg bg-blue-50/70 px-4 py-3">
              ...
              <p className="text-sm text-slate-600">
                Olgan sertifikatlaringizni LinkedIn profilingizga qo&apos;shing &mdash; ish beruvchilar e&apos;tiboriga tushasiz.
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="rounded-xl border-slate-200 shadow-xs">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              ...
              <Link href="/student/kurslarim" className="flex items-center gap-1 text-sm font-medium text-blue-600 hover:text-blue-700">
                Hammasi &rarr;
              </Link>
            </div>
              ...
              {courses.map((course, i) => (
                <div key={i} className="flex items-center justify-between py-3.5">
                  <div>
                    ...
                    <p className="mt-0.5 text-xs text-slate-500">Mentor: {course.mentor} &middot; {course.progress}%</p>
                  </div>
          ...
          <CardContent className="p-6">
            ...
            <div className="mt-4 flex gap-3">
              <Button variant="outline" size="sm" asChild>
                <Link href="/student/tolovlar">To&apos;lovlar tarixi</Link>
              </Button>
              <Button variant="outline" size="sm" asChild>
                <Link href="/student/sozlamalar">Sozlamalar</Link>
              </Button>
            </div>
          </CardContent>
        </Card>
